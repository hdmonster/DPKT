...
public class ListDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setSubtitle(getIntent().getStringExtra("info"));
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);

        pd = new ProgressDialog(ListDetails.this);
    ...
    private void getDetails() {
        ...
        String getSolat = "&solat="+getIntent().getStringExtra("solat");

        String url= "http://dpkt.ubkplus.info/action/attendanceDetails.php?username="+username+getSolat+outputDate;
        pd.show();
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for(int i=0; i < jsonarray.length(); i++) {
                                ...
                                String sholat = jsonobject.getString("Shalat");
