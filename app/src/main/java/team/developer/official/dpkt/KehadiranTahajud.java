...
public class KehadiranTahajud extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kehadiran_tahajud);
    ...
    private void details(){
        ...
        listHadir.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                String day = msolat.getText().toString();
                String date = mdate.getText().toString();
                String info = getIntent().getStringExtra("role");
                String url = getIntent().getStringExtra("DetailsUrl");


                Intent i = new Intent(KehadiranTahajud.this, TahajudDetails.class);
                i.putExtra("day", day);
                i.putExtra("date", date);
                i.putExtra("role", info);
                i.putExtra("url", url);
                finish();
                startActivity(i);
            }
    ...
    public void onStart(){
        ...
        KehadiranTahajud.BackTask bt=new KehadiranTahajud.BackTask();
        bt.execute();
    ...
    private class BackTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try{
                String url = "http://dpkt.ubkplus.info/action/"+getIntent().getStringExtra("RoleUrl")+"?username="+username;
    ...
    private void refreshSwipe(){
        final SwipeRefreshLayout swipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.swipeLayoutT);
